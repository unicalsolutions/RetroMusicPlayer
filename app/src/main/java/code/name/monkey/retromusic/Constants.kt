...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=uz.unical.music"
    const val TRANSLATE = "https://crowdin.com/project/retromusicplayer"
    const val WEBSITE = "https://unical.uz"
    const val GITHUB_PROJECT = "https://github.com/unicalsolutions/Unical-Music-PLayer"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/unicalsolutions"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_INSTAGRAM_LINK = "https://www.instagram.com/unicalsolutions/"
    const val APP_TELEGRAM_LINK = "https://t.me/unicalsolutions"
    const val APP_TWITTER_LINK = "https://twitter.com/retromusicapp"
    const val FAQ_LINK = "https://github.com/unicalsolutions/Unical-Music-PLayer/blob/dev/FAQ_uz.md"
